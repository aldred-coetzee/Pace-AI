"""E2E tests for notion-mcp server startup.
...
class TestServerStartupE2E:
    def test_notion_mcp_boots_and_responds(self):
        """Start notion-mcp as a subprocess and verify it serves HTTP."""
        port = _find_free_port()
        env = {
            "NOTION_MCP_PORT": str(port),
            "NOTION_MCP_DB": ":memory:",
            "PATH": "",
        }
        ...
        try:
            ...
            assert started, f"notion-mcp failed to start on port {port}"
